...
const JWT_SECRET = 'Harryisagoodboye';
...
body('password', "Enter a valid password").isLength({ min: 5 })],
    async (req, res) => {
        ...
        const errors = validationResult(req);      //using express validator to give alert message  
        if (!errors.isEmpty()) {
...
body('password', "Enter a valid password").exists()],
    ...
    //ROUTE 3: Get loggedin user detail using: POST "/api/auth/getuser". login rquired  
